...
// DomainHandlerV1 provides REST API handlers using domain services with split handlers
type DomainHandlerV1 struct {
	// Sub-handlers
...
// NewDomainHandlerV1 creates a new domain-based API handler with split handlers
func NewDomainHandlerV1(
...
func (h *DomainHandlerV1) RegisterRoutes(router *gin.Engine) {
...
func (h *DomainHandlerV1) isUserAuthenticated(c *gin.Context) bool {
	sessionID, err := c.Cookie("session_id")
	return err == nil && sessionID != ""
}

// registerJiraConnectionRoutes registers JIRA connection routes under the new path structure
func (h *DomainHandlerV1) registerJiraConnectionRoutes(managerGroup *gin.RouterGroup) {
...
func (h *DomainHandlerV1) registerJiraConnectionRoutesLegacy(managerGroup *gin.RouterGroup) {
...
func (h *DomainHandlerV1) getFlakyTests(c *gin.Context) {
...
func (h *DomainHandlerV1) resolveFlakyTest(c *gin.Context) {
	testID := c.Param("id")
...
func (h *DomainHandlerV1) ignoreFlakyTest(c *gin.Context) {
	testID := c.Param("id")
