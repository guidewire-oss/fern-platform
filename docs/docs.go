...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Fern Platform Team",
            "url": "https://github.com/guidewire-oss/fern-platform/issues"
        },
        "license": {
            "name": "Apache 2.0",
    ...
    "paths": {
        ...
        "/api/v1/admin/test-runs/bulk-delete": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "description": "List of test run IDs",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "206": {
                        "description": "Partial success — some deletes failed",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/admin/test-runs/{runId}/status": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/flaky-tests": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Project ID to query flaky tests for",
                        "name": "projectId",
                        "in": "query",
                        "required": true
                    }
        ...
        "/api/v1/projects/by-project-id/{projectId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/projects/{projectId}/integrations/jira/connections": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.JiraConnectionResponse"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.CreateJiraConnectionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/projects/{projectId}/integrations/jira/connections/{connectionId}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.UpdateJiraConnectionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/projects/{projectId}/integrations/jira/connections/{connectionId}/credentials": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.UpdateJiraCredentialsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/projects/{projectId}/integrations/jira/connections/{connectionId}/test": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/spec-runs": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Spec run data (suiteRunId, specName, status, startTime, endTime, duration, errorMessage, stackTrace, retries)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/suite-runs": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Suite run data (testRunId, suiteName, status, startTime, endTime, duration, totalSpecs, passedSpecs, failedSpecs)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/summary/{projectId}/{seed}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Test seed or run identifier",
                        "name": "seed",
                        "in": "path",
                        "required": true
                    },
                    {
                        ...
                        "description": "Dimensions to group results by (repeatable)",
                        "name": "group_by",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.TestRunRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/test-runs/by-run-id/{runId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/test-runs/complete": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Completion data (runId, status, endTime, totalTests, passedTests, failedTests, skippedTests)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/test-runs/start": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Test run start data (projectId, runId, branch, commitSha, environment, tags, metadata)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/test-runs/{id}/suite-runs": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/test-runs/{id}/suite-runs/{suiteId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/test-runs/{id}/suite-runs/{suiteId}/spec-runs": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/test-runs/{id}/suite-runs/{suiteId}/spec-runs/{specId}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        "api.CreateJiraConnectionRequest": {
            "type": "object",
            "required": [
                "authenticationType",
                "credential",
        ...
        "api.UpdateJiraConnectionRequest": {
            "type": "object",
            "properties": {
                "jiraUrl": {
                    "type": "string"
        ...
        "api.UpdateJiraCredentialsRequest": {
            "type": "object",
            "required": [
                "authenticationType",
                "credential"
    ...
    "tags": [
        ...
        {
            "description": "Test run submission and retrieval",
            "name": "test-runs"
        },
        {
