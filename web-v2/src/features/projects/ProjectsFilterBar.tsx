...
interface Props {
  ...
  totalCount: number;
  /**
   * Show the Sort control. Defaults to true. The Summaries tree (treemap)
   * view sets this false: a treemap packs tiles by area/health, so there's
   * no list order to sort — showing the control there would be a dead
   * affordance. Search/team/category/favorites still apply in tree view.
   */
  showSort?: boolean;
}
